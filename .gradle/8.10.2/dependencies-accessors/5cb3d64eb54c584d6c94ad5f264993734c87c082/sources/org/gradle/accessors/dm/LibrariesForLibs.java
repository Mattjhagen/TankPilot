...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxLibraryAccessors extends SubDependencyFactory {
        ...
        private final AndroidxCarLibraryAccessors laccForAndroidxCarLibraryAccessors = new AndroidxCarLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>androidx.car</b>
         */
        public AndroidxCarLibraryAccessors getCar() {
            return laccForAndroidxCarLibraryAccessors;
        }
    ...
    public static class AndroidxCarLibraryAccessors extends SubDependencyFactory {
        private final AndroidxCarAppLibraryAccessors laccForAndroidxCarAppLibraryAccessors = new AndroidxCarAppLibraryAccessors(owner);

        public AndroidxCarLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>androidx.car.app</b>
         */
        public AndroidxCarAppLibraryAccessors getApp() {
            return laccForAndroidxCarAppLibraryAccessors;
        }

    }

    public static class AndroidxCarAppLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public AndroidxCarAppLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>app</b> with <b>androidx.car.app:app</b> coordinates and
         * with version reference <b>car.app</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
            return create("androidx.car.app");
        }
        ...
        public Provider<MinimalExternalModuleDependency> getProjected() {
            return create("androidx.car.app.projected");
        }

        /**
         * Dependency provider for <b>testing</b> with <b>androidx.car.app:app-testing</b> coordinates and
         * with version reference <b>car.app</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getTesting() {
            return create("androidx.car.app.testing");
        }
    ...
    public static class CarVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>car.app</b> with value <b>1.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getApp() { return getVersion("car.app"); }
